package com.myshang.server.sys;
...
import com.myshang.server.common.Page;


/**
 * mybatis拦截器,默认mapper里面id后缀为Page的进行分页
 * @author lidongdong
 * 2017年11月21日 下午3:21:42
 */
...
public class PageInterceptor implements Interceptor {
    ...
    /**
     * 从数据库里查询总的记录数并计算总页数，回写进分页参数Page,这样调用者就可用通过 分页参数
     * Page.totalPage获得相关信息。
     * @param sql
     * @param connection
